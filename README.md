# Тестовое задание в котором нужно сделать ревью кода, оставить комменты и на их основе сделать рефакторинг. В main ветке ревью кода и в refactoring ветке уже исправленный мною код.
# Frontend test
